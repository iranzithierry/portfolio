  ...
  return (
    <>
      <div className='py-4'>
        <div className="flex items-center gap-x-3">
          <div className="shrink-0 hidden lg:block">
            <Image width={500} height={500} className="shrink-0 size-16 rounded-full" src="/images/iranzithierry.jpg" alt="Avatar" />
          </div>
      ...
      <div>
        ...
        <ProjectsSection />
        <p className='font-medium text-sm mt-3'>See a list of all my projects On my <Link className='text-primary font-semibold' href="/projects">projects page</Link></p>
      </div>
    </>
  )
}
