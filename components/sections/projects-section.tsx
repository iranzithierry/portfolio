        ...
        return (
          <li key={index} className="relative flex flex-col items-start">
            ...
            {project.links && project.links.length > 0 && (
              <div className="flex justify-between flex-row flex-wrap items-end gap-1 mt-4">
                ...
                <span className="relative ml-auto text-end  z-10 text-xs text-muted-fg">{project.dates}</span>
              </div>
            )}
          </li>
        );
